  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <a
          href="/judges"
          className="hidden sm:inline-flex items-center gap-1.5 border border-[#E5E5E0] hover:border-[#C47D1E] text-[#1A1A18] font-mono text-[11px] uppercase tracking-[0.15em] px-4 py-2 rounded-sm transition-all duration-300"
        >
          Judges Playground ⚖️
        </a>
        <a
